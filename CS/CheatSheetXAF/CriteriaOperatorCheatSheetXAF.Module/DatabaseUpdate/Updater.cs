...
namespace CriteriaOperatorCheatSheetXAF.Module.DatabaseUpdate;
...
public class Updater : ModuleUpdater {
    ...
    private PermissionPolicyRole CreateDefaultRole() {
        ...
        if(defaultRole == null) {
            ...
            defaultRole.AddNavigationPermission(@"Application/NavigationItems/Items/Default/Items/MyTask_ListView", SecurityPermissionState.Allow);
            ...
            defaultRole.AddTypePermissionsRecursively<MyTask>(SecurityOperations.CRUDAccess, SecurityPermissionState.Allow);
        }
        return defaultRole;
    }
}
